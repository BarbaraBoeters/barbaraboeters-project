...
In an ideal world, I would spend more time figuring out how to get the notifications and geofencing working on the background. With the background notifications and geofencing I believe that Plantastic would be a fantastic app to use on a daily basis.
